  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4 font-sans">
      <div className="max-w-md w-full rounded-3xl bg-card border border-border p-6 sm:p-8 shadow-2xl space-y-6 text-center">
        <div className="w-14 h-14 mx-auto rounded-2xl bg-primary/15 border border-primary/30 flex items-center justify-center text-primary">
          <Compass size={28} />
        </div>

        <div className="space-y-2">
          <h2 className="text-xl font-extrabold tracking-tight text-foreground">Discovery Unavailable</h2>
          <p className="text-sm text-muted-foreground">
            Unable to load regional tournaments and upcoming grassroots cups. Please check your network connection.
          </p>
          {error?.message && (
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
          ...
          >
            <RotateCcw size={16} /> Refresh Directory
          </button>
          <Link
            href="/"
