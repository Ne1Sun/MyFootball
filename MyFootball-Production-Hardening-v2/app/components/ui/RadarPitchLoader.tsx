...
export function RadarPitchLoader({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 space-y-6 text-center animate-in fade-in duration-300">
      ...
      <div className={`relative ${dimensionClass} rounded-full bg-emerald-950/80 border-2 border-emerald-500/40 shadow-2xl shadow-emerald-500/10 overflow-hidden flex items-center justify-center`}>
        ...
        <div className="absolute bottom-1/3 right-1/4 w-3 h-3 rounded-full bg-emerald-400 animate-radar-ping [animation-delay:0.7s] pointer-events-none" />
        <div className="absolute top-1/2 right-1/3 w-2.5 h-2.5 rounded-full bg-cyan-400 animate-radar-ping [animation-delay:1.4s] pointer-events-none" />
