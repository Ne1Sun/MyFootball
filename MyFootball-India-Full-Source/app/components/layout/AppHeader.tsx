      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          {user ? (
            <Link
              href="/organize"
              className="hidden sm:inline-flex items-center gap-1.5 text-xs font-bold px-3.5 py-2 rounded-xl bg-primary text-primary-foreground shadow-sm hover:opacity-90 transition"
            >
              <UserCheck size={14} />
        ...
        <div className="md:hidden border-t border-border bg-background px-4 py-4 space-y-2 shadow-xl animate-in slide-in-from-top-2">
          ...
          <div className="pt-3 border-t border-border flex items-center justify-between">
            {user ? (
              ...
              >
                <UserCheck size={15} /> Signed in as {user.displayName}
              </Link>
            ) : (
              <a
                href="/signin-with-chatgpt?return_to=%2Forganize"
